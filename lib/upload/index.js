...
var Upload = function (_React$Component) {
    ...
    _createClass(Upload, [{
        ...
        value: function fileListRender() {
            ...
            return _react2.default.createElement(_uploadFileList2.default, { type: this.props.listType,
        ...
        key: 'fileInputRender',
        value: function fileInputRender() {
            var _this5 = this;
        ...
        value: function render() {
            ...
            var others = _objectWithoutProperties(_props, ['className', 'type', 'children']);

            var classes = (0, _classnames2.default)(_defineProperty({
                'lib-pc-upload-lib-upload': true
            }, className, className));
